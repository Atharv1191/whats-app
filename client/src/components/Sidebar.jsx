...
export default function Sidebar({
  ...
  return (
    <div
      ...
      } sm:translate-x-0 fixed sm:relative top-0 left-0 w-64 h-full bg-white shadow-md z-40 transform transition-transform duration-300 overflow-hidden`}
    >
      {/* Mobile close button */}
      ...
      {/* Chat list */}
      <ul className="overflow-y-auto h-[calc(100%-64px)] p-2">
        {chats.map((chat) => (
          <li
            key={chat.wa_id}
            onClick={() => {
